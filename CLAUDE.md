...
Before creating any wiki page, read `templates/wiki-page.md` and use it as the base structure. Fill in all frontmatter fields — do not leave placeholder values like {{title}} in the final file.
